...
DB_NAME = os.getenv(key="DB_NAME", default="social_network")
DB_USER = os.getenv(key="DB_USER", default="social_network_user")
DB_PASSWORD = os.getenv(key="DB_PASSWORD", default="dsfjjwejed")
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_AUTHENTICATION_CLASSES": [
        "service_auth.auth.JWTAuthentication"
    ],
    "DEFAULT_PERMISSION_CLASSES": [
        "rest_framework.permissions.IsAuthenticated",
    ],
    "EXCEPTION_HANDLER": "social_network.utils.exception_handler.custom_exception_handler",
